            ...
            FragmentOutput frag(v2f i)
            {
                ...
                float texMask = 1;
                    ...
                    for (int itr = 0; itr < 4; ++itr)
                    {
                        ...
                        texMask -= _TextureLayerWeights[index] * 2 * weight; 
                    }
                ...
                if (clearMask.r * 256 > _ClearLayer+0.5)
                    w *= 1.0 - clearMask.y;
                ...
                if (w > 0)
                {
                    ...
                    {
                        randomRet.y = lerp(random.scaleHeightRange.x, random.scaleHeightRange.y, randomValues.y) * scaleByWeight;
                        randomRet.z = lerp(random.scaleWidthRange.x, random.scaleWidthRange.y, randomValues.y) * scaleByWeight;
                    }
                    else
                    {
                        randomRet.y = lerp(random.scaleHeightRange.x, random.scaleHeightRange.y, randomValues.y) * scaleByWeight;
                        randomRet.z = lerp(random.scaleWidthRange.x, random.scaleWidthRange.y, randomValues.z) * scaleByWeight;
                    }
