...
namespace JBooth.MicroVerseCore
{
    ...
    public class GUIUtil
    {
        ...
        public static void DrawFalloffFilter(Object owner, FalloffFilter f, Transform trans, bool allowGlobal)
        {
        ...
        public static void DrawTextureLayerSelector(SerializedProperty property)
        {
            ...
            else
            {
                ...
                if (!MicroVerse.instance.msConfig.HasTerrainLayer(l))
                {
                    EditorGUILayout.HelpBox("Layer is not found in MicroSplat texture array", MessageType.Warning);
