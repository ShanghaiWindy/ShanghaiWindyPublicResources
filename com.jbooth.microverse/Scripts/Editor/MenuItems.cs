...
namespace JBooth.MicroVerseCore
{
    class MenuItems
    {
        ...
        static void CreateMicroVerseForExisting()
        {
            ...
            else
            {
                ...
                if (EditorUtility.DisplayDialogComplex("Confirm", "Please make sure your terrain data is backed up before performing this operation.", "I have backed up", "Cancel", "") == 0)
                {
                    ...
                    foreach (var terrain in terrains)
                    { 
                        var cp = CreateGO("CopyPaste Stamp").AddComponent<CopyPasteStamp>();
        ...
        [MenuItem("GameObject/MicroVerse/" + MenuStamps + "Create Mask Stamp", false, k_MenuPriorityStamps + 5)]
        ...
        [MenuItem("GameObject/MicroVerse/" + MenuStamps + "Create Object Stamp", false, k_MenuPriorityStamps + 6)]
        ...
        [MenuItem("GameObject/MicroVerse/" + MenuStamps + "Create Occlusion Stamp", false, k_MenuPriorityStamps + 7)]
        static void CreateOcclusionStamp()
        {
            CreateGO("Occlusion Stamp").AddComponent<OcclusionStamp>();
        }

        [MenuItem("GameObject/MicroVerse/" + MenuStamps + "Create Texture Stamp", false, k_MenuPriorityStamps + 8)]
...
#if __MICROVERSE_VEGETATION__
        [MenuItem("GameObject/MicroVerse/" + MenuStamps + "Create Tree Stamp", false, k_MenuPriorityStamps + 9)]
