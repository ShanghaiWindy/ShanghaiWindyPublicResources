        ...
        public static void DrawNoisePreview()
        {
            ...
            foreach (var terrain in MicroVerse.instance.terrains)
            {
                if (terrain != null)
                {
                    ...
                    noiseMat.SetTextureOffset("_NoiseTexture", noisePreview.GetTextureParams());
                ...
                switch (filterSetType)
                {
                    ...
                    case FilterSetType.Texture:
                    {
                        if (filterSet != null)
                        {
                            ...
                            filterSetMat.SetFloatArray("_TextureLayerWeights", filterSet.GetTextureWeights(terrain.terrainData.terrainLayers));
