...
{
    [Serializable, VolumeComponentMenu("Post-processing/Light Scattering")]
    public sealed class LightScatteringPostProcess : VolumeComponent, IPostProcessComponent
    {
        ...
        public MinFloatParameter fogDensity = new MinFloatParameter(4, 0);

        [Tooltip("Determine how far to sample the occluder texture (in screen space distance).")]
        public ClampedFloatParameter maxRayDistance = new ClampedFloatParameter(0.2f, 0.0f, 1.0f);
